            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="waves-effect waves-dark" href="{{url('/pangkat')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Pangkat </span></a>
                        </li>
                        <li>
                            <a class="waves-effect waves-dark" href="{{url('/anggota')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Anggota </span></a>
                        </li>
                        {{-- <li>
