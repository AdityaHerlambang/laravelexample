                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form method='post' action='/anggota/{{$data->id}}'>
                                                        @csrf
                                                        @method('DELETE')
                ...
                <div id="modal-create" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form enctype="multipart/form-data" action="{{url('/anggota')}}" method="post">
                                @method('POST')
                                @csrf
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Nama</label>
                                            <select class="form-control select2" name="pangkat_id" required>
                        ...
                        <div class="modal-content">
                            ...
                            <form enctype="multipart/form-data" id="form-edit" method="post">
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Nama</label>
                                            <select class="form-control select2 selectedit" name="pangkat_id" required>
                                                @foreach ($dataPangkat as $pangkat)
                                                    <option value="{{$pangkat->id}}">{{$pangkat->pangkat}}</option>
                                                @endforeach
                                            </select>
        ...
        jQuery(document).ready(function ($) {
            ...
            $(document).on('click','.btn-edit',function(){
                ...
                $.get(url + '/' + id, function (data) {
                    ...
                    $('#form-edit').attr('action',"{{url('/anggota/')}}"+"/"+id)
                    $('#id').val(id);
                    $('#nama').val(data.nama);
                    $('.selectedit').val(data.pangkat_id);
